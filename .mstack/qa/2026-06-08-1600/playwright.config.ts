...
// Use HTTPS Replit dev URL when available — needed because BetterAuth issues
// __Secure- cookies when its baseURL is HTTPS, and Chrome rejects __Secure-
// cookies with secure:false in storageState. Fall back to localhost for CI.
