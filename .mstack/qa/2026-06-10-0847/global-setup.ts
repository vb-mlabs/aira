...
// running dev server at localhost:5000 to get a session cookie.
...
const COOKIE_DOMAIN = REPLIT_DOMAIN ?? "localhost"
...
qaAdminSetup().catch((err) => { console.error(err); process.exit(1) })
