  ...
  it("passes a clearly-compliant palette", () => {
    ...
    const themes = {
      light: {
        ...
        input: black,
        ring: black,
        // AIRA tier + info extensions — same black-on-white pattern so every
        // pair stays at 21:1. Added 2026-05-25 alongside the new tier pairs
        // in scripts/check-contrast.ts PAIRS.
        sponsoredTop: black,
        sponsoredTopForeground: white,
        sponsoredMid: black,
        sponsoredMidForeground: white,
        regular: black,
      ...
      dark: {
        ...
        ring: white,
        sponsoredTop: white,
        sponsoredTopForeground: black,
        sponsoredMid: white,
        sponsoredMidForeground: black,
        regular: white,
        regularForeground: black,
        info: white,
  ...
  it("flags a bad pair (white on white)", () => {
    const themes = {
      light: {
        ...
        // AIRA tier + info extensions — compliant pairs so only the
        // foreground/background pair fails (per the test's assertion).
        sponsoredTop: "oklch(0.205 0 0)",
        sponsoredTopForeground: "oklch(0.985 0 0)",
        sponsoredMid: "oklch(0.205 0 0)",
        sponsoredMidForeground: "oklch(0.985 0 0)",
        regular: "oklch(0.205 0 0)",
        regularForeground: "oklch(0.985 0 0)",
        info: "oklch(0.205 0 0)",
      ...
      dark: {
        ...
        input: "oklch(1 0 0)",
        ring: "oklch(1 0 0)",
        sponsoredTop: "oklch(1 0 0)",
        sponsoredTopForeground: "oklch(0.145 0 0)",
        sponsoredMid: "oklch(1 0 0)",
        sponsoredMidForeground: "oklch(0.145 0 0)",
        regular: "oklch(1 0 0)",
        regularForeground: "oklch(0.145 0 0)",
        info: "oklch(1 0 0)",
