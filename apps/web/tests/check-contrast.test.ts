  ...
  it("passes a clearly-compliant palette", () => {
    ...
    const themes = {
      light: {
        ...
        tier1: black,
        tier1Foreground: white,
        tier2: black,
        tier2Foreground: white,
        tier3: black,
        tier3Foreground: white,
        info: black,
      ...
      dark: {
        ...
        ring: white,
        tier1: white,
        tier1Foreground: black,
        tier2: white,
        tier2Foreground: black,
        tier3: white,
        tier3Foreground: black,
        info: white,
  ...
  it("flags a bad pair (white on white)", () => {
    const themes = {
      light: {
        ...
        tier1: "oklch(0.205 0 0)",
        tier1Foreground: "oklch(0.985 0 0)",
        tier2: "oklch(0.205 0 0)",
        tier2Foreground: "oklch(0.985 0 0)",
        tier3: "oklch(0.205 0 0)",
        tier3Foreground: "oklch(0.985 0 0)",
      ...
      dark: {
        ...
        ring: "oklch(1 0 0)",
        tier1: "oklch(1 0 0)",
        tier1Foreground: "oklch(0.145 0 0)",
        tier2: "oklch(1 0 0)",
        tier2Foreground: "oklch(0.145 0 0)",
        tier3: "oklch(1 0 0)",
        tier3Foreground: "oklch(0.145 0 0)",
        info: "oklch(1 0 0)",
