...
/**
 * /account/profile — one screen with four sections: Photo, Display name,
...
function Section({
  ...
  // Borderless card matching the hub's row-group visual: rounded corners,
  // card fill, no outer stroke. Keeps the profile screen visually
  // consistent with /account/index and other stack sub-pages.
  return (
    <View className="rounded-xl bg-card p-4" style={{ gap: 12 }}>
      <View>
